...
const Projects: React.FC = () => {
  ...
  const projectsList = [
    ...
    },
    {
      ...
      image: '/wonderlust_real_app.png',
      description: 'A full-stack travel platform featuring complete CRUD functionality for exploring vacation stays. Includes category filters (Rooms, Cities, Mountains, Castles, Pools, Camping, Farms, Arctic), search bar, GST tax calculator toggle, and Google Maps API.',
      ...
      highlights: [
        { icon: <Code size={20} style={{ color: 'var(--color-cyan)' }} />, text: 'Multi-category stay exploration (Trending, Iconic Cities, Mountains, Pools, Farms, Arctic).' },
        { icon: <MapPin size={20} style={{ color: '#ec4899' }} />, text: 'Integrated Google Maps API for real-time geolocation mapping and place search.' },
        { icon: <ShieldCheck size={20} style={{ color: 'var(--color-indigo)' }} />, text: 'Dynamic tax calculation toggle (+18% GST display) and full user authentication & reviews.' },
      ],
    },
    {
      id: 'hospital',
      ...
      domain: 'hospital-management-system-pi-roan.vercel.app',
      image: '/hospital_real_app.png',
      description: 'A comprehensive multi-role healthcare portal (HMS) featuring Admin, Doctor, and Patient dashboards. Manages appointments, revenue streams, department rosters, Blood Bank, Pharmacy inventory, Razorpay payments, and Chart.js analytics.',
      liveUrl: 'https://hospital-management-system-pi-roan.vercel.app',
      githubUrl: 'https://github.com/shyam-08-02-2004',
      techStack: ['React.js', 'Node.js', 'Express.js', 'MongoDB', 'Chart.js', 'Tailwind CSS', 'Razorpay', 'Cloudinary'],
      highlights: [
        { icon: <Activity size={20} style={{ color: 'var(--color-cyan)' }} />, text: 'Multi-role Admin Dashboard with live stats (Revenue, Patients, Active Doctors, Bookings) & Chart.js analytics.' },
        { icon: <Server size={20} style={{ color: 'var(--color-purple)' }} />, text: 'Integrated module management for Doctors, Departments, Patients, Blood Bank, and Pharmacy.' },
        { icon: <Database size={20} style={{ color: '#ec4899' }} />, text: 'Razorpay payment gateway integration for appointment billing & Cloudinary document storage.' },
      ],
    },
    {
      id: 'dragon-tiger',
